...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Aplikasi CRUD dengan PHP">
        <meta name="keywords" content="Aplikasi CRUD dengan PHP">
        <meta name="author" content="MTAbrori">
        
        <!-- favicon -->
        <link rel="shortcut icon" href="assets/img/rafft.png">
        <!-- Bootstrap CSS -->
    ...
    <body>
            ...
            <footer class="pt-4 my-md-4 pt-md-3 border-top">
                <div class="row">
                    <div class="col-12 col-md center">
                        Known me @ my : <a class="text-info" href="">Sosial Media</a>
                    </div>
                </div>
            </footer>
        </div>
		...
		<div class="container-fluid">
            <footer 
                <div class="row">
                    <div class="col-12 col-md center">
                        <a class="text-info" href="https://www.instagram.com/mtabrori/">Instagram</a>
                    </div>
                </div>
            </footer>
        </div>
		...
		<div class="container-fluid">
            <footer 
                <div class="row">
                    <div class="col-12 col-md center">
                        <a class="text-info" href="https://twitter.com/methor17">Twitter</a>
                    </div>
                </div>
            </footer>
        </div>
		...
		<div class="container-fluid">
            <footer 
                <div class="row">
                    <div class="col-12 col-md center">
                        <a class="text-info" href="https://www.facebook.com/muhammadthoriq.abrori/">Facebook</a>
                    </div>
                </div>
            </footer>
        </div>
